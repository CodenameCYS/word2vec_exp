...
class Word2Vec(object):
    ...
    def build(self, dim, window_size):
        ...
        embedding = tf.tile(embedding, (1, window_size, 1))
...
if __name__ == "__main__":
    ...
    pickle.dump(res, open("data/skip_gram_before_train.pkl", "wb+"))

    model.train(x, y, batch_size=256, epochs=50)
    model.save("model/skip_gram_embedding.h5")
    
    res = model.test(color + place + jobs)
    pickle.dump(res, open("data/skip_gram_after_train.pkl", "wb+"))
